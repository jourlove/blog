...
<div class="result_wrap">
    <form action="{{url('admin/web_config')}}" method="post">
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
            <tr>
            ...
            <tr>
                <th>内容类型：</th>
                <td>
                    <input type="radio" name="content_type" value="input" checked onclick="showTr()">input　
                    <input type="radio" name="content_type" value="textarea" onclick="showTr()">textarea　
                    <input type="radio" name="content_type" value="radio" onclick="showTr()">radio
                </td>
            </tr>
            <tr class="content_value">
                <th>内容类型可选值：</th>
                <td>
                    <input type="text" class="lg" name="content_value" value="1|开启,0|关闭">
